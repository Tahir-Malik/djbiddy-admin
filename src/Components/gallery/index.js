                ...
                <div className='white-bx-style  m-b-30'>
                    <div className='GalleryBack'>
                        <ul className='GalleryList-back'>
                                ...
                                <Fragment>
                                    {arrayNotNull(props.gallery) ? (
                                        props.gallery.map((image, index) => (
                                            <li key={`${index}`}>
                                                <figure className="imageWrp" >
                                                    <img src={notNull(image.image) && image.image.name === undefined ? image.image : URL.createObjectURL(image.image)} alt='gallery' />
                                                    <span
                                                        className='removeImg'
                            ...
                            <div className="addMedia-New-Photos BlueBG" >
                                <input
                                    type='file'
                                    id='imageUpload'
                                    multiple
