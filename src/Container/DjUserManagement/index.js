...
import { getDjUserList, deleteUser, resumeSuspendUser } from '../../Redux/Actions/UsermanageAction';
...
class DJUserManagement extends Component {
	constructor(props) {
		super(props);
		this.state = {
			activePage: 0,
	...
	render() {
		return (
			<div className="FormAndHidden">
				...
				<DashboardHead
					secondaryHeadingOne="DJ User Management "
					secondaryHeadingTwo="  "
											...
											<tr key={index}>
												...
												<td>
													<div className="action-type">
														<Link
															to={{
																pathname: routeRules.djUserDetails,
																state: {
																	id: user.id,
																	userDetails: user,
																	redirect: 'DJUser',
...
const mapDispatchToProps = (dispatch) => {
	return {
		getDjUserList: (data) => dispatch(getDjUserList(data)),
		deleteUser: (id) => dispatch(deleteUser(id)),
		resumeSuspendUser: (data) => dispatch(resumeSuspendUser(data)),
	};
};

export default connect(mapStateToProps, mapDispatchToProps)(DJUserManagement);
